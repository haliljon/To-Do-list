...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"boxCheck\": () => (/* binding */ boxCheck)\n/* harmony export */ });\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module './modules/updateStatus'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\n\n\nfunction boxCheck(index, isTrue) {\n  const information = JSON.parse(localStorage.getItem('lists')) || [];\n  console.log(information);\n  Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './modules/updateStatus'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(index, isTrue, information);\n  localStorage.setItem('lists', JSON.stringify(information));\n}\n\n\n//# sourceURL=webpack://to-do-list/./src/modules.js?");
